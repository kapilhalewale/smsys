                ...
                <div class="data_col">
                    <div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">	
								<div class="x_title">
                                    <h2><i class="fa fa-cogs"></i> Subjects</h2>
	                                     <div style="float:right;">
										  <span class="label label-primary" style="border:1px solid #1A82C3;color:white">1</span>
										  <span class="label label-primary" style="border:1px solid #1A82C3;color:white">2</span>
										  <span class="label label-primary" style="border:1px solid #1A82C3;color:white">3</span>
										  <span class="label label-primary" style="border:1px solid #1A82C3;color:white">4</span>
										  <span class="label label-primary" style="border:1px solid #1A82C3;color:white">5</span>
									</div>
												...
												<div class="form-group">
														<label class="control-label col-md-3 col-sm-3 col-xs-12">Name</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input id="name" name="name" class="form-control" type="text"  placeholder="Ex: Java Programming">
															</div>
													</div>
												<div class="form-group">
														<label class="control-label col-md-3 col-sm-3 col-xs-12">Subject Code</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<input id="name" name="name" class="form-control" type="text"  placeholder="Ex: 06CS405">
															</div>
													</div>
												<div class="form-group">
						...
						<div class="x_title">
							<div style="float:right;">
   		                        <a href="subject">
									<button type="button" class="btn btn-success btn-sm"><i class="fa fa-chevron-right"></i>  Done</button>
								</a>
							</div>
                              </div>
                    </div>
