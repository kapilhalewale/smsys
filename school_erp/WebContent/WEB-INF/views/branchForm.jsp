                    ...
                    <div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
										<form:form method="post" action="branch-save" modelAttribute="branch">   
													<div class="form-group col-md-12">
														<div class="col-md-6">
																<label class="control-label col-md-3 col-sm-3 ">Select Group</label>
																	<div class="col-md-6 col-sm-6">
																		<form:select path="group.id" cssClass="form-control"  items="${groups}" itemValue="id"  itemLabel="name" >
																			</form:select>
																	</div>
														</div>
														<div class="col-md-6 ">
																<label class="control-label col-md-3 col-sm-3">Branch  Name</label>
																	<div class="col-md-6 col-sm-6">
														...
														<div class="form-group col-md-12">
																	<div class="col-md-6">
																			<label class="control-label col-md-3 col-sm-3 ">Select Country</label>
																				<div class="col-md-6 col-sm-6">
																					<form:select path="country.id" cssClass="form-control"  items="${countries}" itemValue="id"  itemLabel="name"  ></form:select>
																				</div>
																	</div>
																	<div class="col-md-6">
														...
														<div class="form-group col-md-12">
																<div class="col-md-6">
																		<label class="control-label col-md-3 col-sm-3 ">Select City</label>
																			<div class="col-md-6 col-sm-6">
																				<form:select path="city.id" cssClass="form-control"  items="${cities}" itemValue="id"  itemLabel="name" >
																					</form:select>
																			</div>
																</div>
															</div>													
